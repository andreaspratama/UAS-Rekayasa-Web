...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Maha <?php echo $button ?></h2>
	    ...
	    <input type="hidden" name="id_maha" value="<?php echo $id_maha; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('maha') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>